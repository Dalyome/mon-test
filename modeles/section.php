...
$sql = "SELECT a.id, a.letitre,a.util_id ,SUBSTRING(a.ladesc,1,250) as ladesc,a.ladate,ahr.article_id,ahr.rubrique_id,r.id AS
...
foreach($affiche_ecrivain as $affiche){
    ...
    $contenu .= "<p>".$affiche['ladesc']."... <a href='?iddesc=".$affiche['id']."'>Lire la suite</a></p>";
